...
use crate::whiteboard_kernel::WhiteboardWidget;
use xos_core::engine::EngineState;
use crate::ui_events::{parse_app_xos_event, PyUiEventKind};
...
pub fn dispatch_whiteboard_widget_from_app(
    ...
    crate::engine::py_engine_tls::with_callback_engine_state_mut(|state| {
