...
def make_text(self, x1=0.0, y1=0.0, x2=1.0, y2=1.0, text: str = "", fontsize: float=DEFAULT_FONT_SIZE, centered: bool = False):
...
class TextDemo(xos.Application):
    def __init__(self):
        ...
        self.text1 = make_text(self, x1=0.0, y1=0.0, x2=1.0, y2=0.2, text="display", fontsize=55.0, centered=True)
        self.text2 = make_text(self, x1=0.0, y1=0.2, x2=1.0, y2=1.0, text="summary", fontsize=32.0)
